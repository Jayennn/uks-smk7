        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row justify-around gap-4">
            ...
            <div className="px-6 flex flex-col">
              <p className="text-lg font-semibold uppercase">Link Terkait</p>
          ...
          <div className="pb-8 flex flex-col md:flex-row items-center justify-between">
            <p className="text-sm font-medium">Copyright &copy; PPLG_2021 | ALL RIGHTS RESERVED</p>
